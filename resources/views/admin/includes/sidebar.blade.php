        ...
        <nav>
            ...
            <ul class="main-navigation-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="#"><span class="title"> Manage Users </span></a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:void(0)">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="#"><span class="title"> Unread Query </span></a></li>
                        <li><a href="#"><span class="title"> Read Query </span></a></li>
                    </ul>
                </li>
                <li>
                    <a href="#">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="#"><span class="title"> B/w dates reports </span></a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:void(0)">
